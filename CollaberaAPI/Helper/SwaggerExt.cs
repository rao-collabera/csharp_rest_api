...
namespace CollaberaAPI
{
    ...
    public class SwaggerExt : IOperationFilter
    {
        ...
        public SwaggerExt(IMemoryCache memoryCache)
        {
            _cache = memoryCache;
        }
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            KeyValuePair<string, object> item; KeyValuePair<string, object> item3; List<IOpenApiAny> myEnum = new();
            Dictionary<string, OpenApiExample> MyExamples = new();
